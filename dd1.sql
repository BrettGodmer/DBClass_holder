...
*/
CONSTRAINT IC2 CHECK (WHERE priority ='high' THEN cost > 2000),
/*
IC3: The cost of a medium priority order is between 800 and 2200 (inclusive).
*/
CONSTRAINT IC3 CHECK (WHERE priority = 'medium' THEN cost >= 800 AND cost <= 2200),
/*
IC4: The cost of a low priority order is less than 1000.
*/
CONSTRAINT IC4 CHECK (WHERE priority = 'low' THEN cost < 1000)
);
--
--
